...
- [3d-files/](3d-files/)
  - CX100 retrofit panel and PCB mount files, including [CX100-panel.step](3d-files/CX100-panel.step), [CX100-panel-dcled.step](3d-files/CX100-panel-dcled.step), and [CX100-pcb-mounts.step](3d-files/CX100-pcb-mounts.step)
  - CX50 retrofit panel and PCB mount files, including [CX50-panel.3mf](3d-files/CX50-panel.3mf), [CX50-panel-dcled.step](3d-files/CX50-panel-dcled.step), and [CX50-pcb-mounts.step](3d-files/CX50-pcb-mounts.step)
  - Optional CX100 subwoofer panel files, amp cradle files, and connector models are also included in [3d-files/](3d-files/)
...
- [pcb-files/](pcb-files/)
  - Main Altium source files: [beovox-poe.PrjPcb](pcb-files/beovox-poe.PrjPcb), [beovox-poe.SchDoc](pcb-files/beovox-poe.SchDoc), [beovox-poe.PcbDoc](pcb-files/beovox-poe.PcbDoc), [beovox-poe.OutJob](pcb-files/beovox-poe.OutJob), [beovox-poe.IntLib](pcb-files/beovox-poe.IntLib), and [beovox-poe.LibPkg](pcb-files/beovox-poe.LibPkg)
  - Zipped Gerber files for PCB fabrication: [beovox-poe-v2.1-mfg.zip](pcb-files/beovox-poe-v2.1-mfg.zip)
  - Exported manufacturing outputs: [BOM/](<pcb-files/Project Outputs for beovox-poe/BOM/>), [Pick Place/](<pcb-files/Project Outputs for beovox-poe/Pick Place/>), [Gerber/](<pcb-files/Project Outputs for beovox-poe/Gerber/>), [NC Drill/](<pcb-files/Project Outputs for beovox-poe/NC Drill/>), and [ExportSTEP/](<pcb-files/Project Outputs for beovox-poe/ExportSTEP/>)
  - Reference PDFs: [beovox-poe_FabDwg.PDF](<pcb-files/Project Outputs for beovox-poe/beovox-poe_FabDwg.PDF>) and [beovox-poe_Schematic.PDF](<pcb-files/Project Outputs for beovox-poe/beovox-poe_Schematic.PDF>)
...
|                                                  |                                                                                                                                  |                                                                                                                                                                                                                                                                             |                                                                |
| **Other**                                        |                                                                                                                                  |                                                                                                                                                                                                                                                                             |                                                                |
| **4 pcs** M3 x 4 mm (5mm OD) threaded inserts             | Inserts for the printed PCB mount parts.                                                                                         | [Assorted Threaded Inserts](https://a.co/d/07zoHJ45)                                                                                                                                                                                                                        | $15.98                                                         |
| **6 pcs** M3 x 8 mm flat-head screws            | Screws for fastening the PCB to the printed mounts                                                                               | [Assorted Hex Screws](https://a.co/d/05N6zpqh)                                                                                                                                                                                                                              | $12.99                                                         |
...
## Panel Mount
Separate panel files are provided for CX50 and CX100 cabinets because the rear-panel geometry is different.
### 3D Printing
For CX100, print `3d-files/CX100-panel.step` or `3d-files/CX100-panel-dcled.step`, plus `3d-files/CX100-pcb-mounts.step`.

For CX50, print `3d-files/CX50-panel.3mf` or `3d-files/CX50-panel-dcled.step`, plus `3d-files/CX50-pcb-mounts.step`.

Optional printable parts include the CX100 subwoofer panel variants, `3d-files/amp-cradle.step`, `3d-files/dc-barrel-plug.step`, and the `3d-files/mini-xlr-plug-*.step` models.
### Rear Panel Opening
...
1. Print your chosen CX50 or CX100 panel file before you touch the speaker cabinet.
